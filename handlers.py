    ...
    try:
        ...
        if not is_subscribed:
            ...
            update.message.reply_text(
                "👋 Использование бота пока бесплатное, но для того, чтобы использовать весь "
                "функционал, вам нужно быть подписанным на канал автора бота @expert_buyanov\n\n"
                "Где он рассказывает как запускает прибыльный канал в Telegram с нуля, "
                "на своём примере, показывает, как привлекать аудиторию, продавать рекламу "
                "и товары/услуги используя этого бота.",
