    ...
    try:
        ...
        if not is_subscribed:
            ...
            update.message.reply_text(
                "👋 Бот пока бесплатный, но для того, чтобы использовать весь функционал, "
                "вам нужно быть подписанным на канал автора бота @expert_buyanov\n\n"
                "Где он рассказывает как запускает прибыльный Telegram канал с нуля используя этого бота.",
        ...
        menu_text = (
            ...
            "которые прогревают к продаже товаров/услуг/курсов для вашего Telegram канала.\n\n"
