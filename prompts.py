...
def generate_product_repackaging(data: Dict[str, str]) -> str:
    ...
    try:
        ...
        Требования к ответу:
        1. Четко опиши основную боль аудитории
        2. Объясни, как продукт решает эту проблему
        3. Подчеркни уникальность предложения
        4. Опиши конкретный результат
        ...
        - Убедительным, но без агрессивного маркетинга
        """
